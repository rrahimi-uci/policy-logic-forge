...
Dropped relative to the source pipeline's version of this file: rule-type
palette / quick-filter-button checks and graph-name-to-domain inference, both
of which exercised utils.config's UI-only rule-type color palette and
ui.backend.services.graph_service — neither exists in this repo (no HTML
visualizer, no UI backend; see README.md "Scope").
"""
